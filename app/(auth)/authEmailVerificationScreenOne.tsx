                ...
                <KeyboardAwareScrollView contentContainerStyle={{ flex: 1 }}>
                    ...
                    <View className="flex px-5 py-5 flex-1 gap-y-10">
                        ...
                        <View className="h-72 px-5 flex-1 mb-10">
                            <Image source={Images.authEmailVerificationScreenOne} contentFit="contain" style={{ flex: 1 }} />
                        </View>

                        <View className="flex gap-y-5">
                            <Text className="text-4xl font-bold text-center text-blue-700">Email Verification</Text>
